# Component C: The Philosopher

## 1. Core Responsibility
負責撰寫 **內心獨白 (Monologue)**、**感官描寫 (Sensory)** 與 **主題昇華 (Theme)**。

## 2. The Genesis Philosophy (創世哲學)
*   **The Root Law (根律)**: 角色如何感知到世界的底層邏輯？
    *   *Sensory*: 聽見「巴別塔的雜訊」、看見「萬物的幾何結構」、聞到「臭氧與舊數據的焦味」。
...
## [NEXT STEP]
**Output Format**: `Theme: [Philosophical Conflict]. Monologue: "[Character's Inner Thought]". Sensory: [Specific Sights/Sounds].`
