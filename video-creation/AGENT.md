...
- **5 層次定義**：
    - **L1 - 近場特效層 (Near-Field FX)**：創造深度，包含擬聲字 (SFX)、極端透視特寫（拳頭/武器）、向鏡頭噴濺的 **深色線框碎屑 (Dark Wireframe Debris) 與能量粒子**。
...
| **7. FX/Physics (物理)** | **5%** | 是否使用 **深色線框與紋壓染色 (Dark Wireframe & Energy Tint)** 取代血腥？ | 出現寫實血腥 (Blood/Gore/Red Liquid) 則 **重寫** (-5分) |
